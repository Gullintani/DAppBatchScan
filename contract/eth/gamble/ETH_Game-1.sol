...
contract Lucky25{
    ...
    uint8[25] public winners;
    uint8[25] public previouswinners;
    bool[51] public occupied;
   ...
   function withdraw() public{
    ...
    function random() public view returns (uint8) {
        ...
        return randomHash % 50;
    }
    
    function getlist() public constant returns(bool[51]){
        return occupied;
    }
    
    function previouswinner() public constant returns(uint8[25]){
